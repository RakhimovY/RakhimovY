...
# by Andrew Grant, 2022-2025. Personalized for RakhimovY, 2026.
import datetime
...
def recursive_loc(owner, repo_name, data, cache_comment, addition_total=0, deletion_total=0, my_commits=0, cursor=None):
    ...
    # GitHub's GraphQL API intermittently returns 502s on commit-history pagination; retry a few times.
...
if __name__ == '__main__':
    """
    Original: Andrew Grant (Andrew6rant), 2022-2025. Adapted for RakhimovY.
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(1999, 10, 23))
